...
public class TopicoController {
	...
	@GetMapping
	public Page<TopicoDTO> listaTopicos(@RequestParam(required = false) String nomeCurso, @RequestParam int pagina, @RequestParam int qtd, @RequestParam String ordenacao) {
